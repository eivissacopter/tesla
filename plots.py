...
Contains functions for trend lines and retention curve calculations.
"""
...
def add_trend_lines(fig, batteries, filtered_df, x_column, y_column, trend_line_type):
    ...
    Args:
        ...
        trend_line_type: type of regression ('Linear Regression', 'Logarithmic Regression', or 'Polynomial Regression (3rd Degree)')
    
    Returns:
        Updated plotly figure with trend lines
    """
