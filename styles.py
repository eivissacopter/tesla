"""
styles.py - CSS and HTML style constants for the Tesla Battery Analysis Dashboard
"""

# Header CSS/HTML with Tesla Battery Analysis banner
HEADER_HTML = """
<style>
    .header {
        display: flex;
...
# Google Forms logo with animated arrows
GOOGLE_FORM_HTML = """
<style>
    @keyframes pulse {
...
# Sidebar Banner CSS/HTML with logos and links
SIDEBAR_BANNER_HTML = """
<style>
    .sidebar-content {
        display: flex;
